...
class ViewSupervisors extends StatefulWidget {
  const ViewSupervisors({Key? key}) : super(key: key);

  @override
  State<ViewSupervisors> createState() => _ViewSupervisorsState();
}

class _ViewSupervisorsState extends State<ViewSupervisors> {
  List supervisors = [];
  bool load = true;
